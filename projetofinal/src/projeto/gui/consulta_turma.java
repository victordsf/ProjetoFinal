...
public class consulta_turma extends JFrame {
	...
	public consulta_turma() {
		...
		JLabel lblNewLabel = new JLabel("Sistema de Consulta de Turmas");
		...
		final DefaultTableModel modelo = new DefaultTableModel();
		        ...
		        modelo.addColumn("CPF do Professor");
		        ...
		        try{
		            ...
		            while(rs.next()){
		              ...
		              String datat =rs.getString("data_termino");
		              String cpf = rs.getString("cpf_professor");
		             
		   
		 
		           
		             modelo.addRow(new Object[] {cod, curso, turno, datai,datat,cpf});
		            }
