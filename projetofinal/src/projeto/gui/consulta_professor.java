...
public class consulta_professor extends JFrame {
	...
	public consulta_professor() {
		...
		JLabel lblNewLabel = new JLabel("Sistema de Consulta de Professores");
		...
		final DefaultTableModel modelo = new DefaultTableModel();
		        ...
		        modelo.addColumn("Área de Atuação");
		        modelo.addColumn("Especialização");
		        modelo.addColumn("Expertises");
		        ...
		        try{
		            ...
		            while(rs.next()){
		              ...
		              String espec = rs.getString("especializacao");
		              String expertise = rs.getString("expertise");
		   
		 
		           
		             modelo.addRow(new Object[] {cpf, area,espec,expertise});
		            }
