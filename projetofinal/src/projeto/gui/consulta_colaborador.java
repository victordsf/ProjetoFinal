...
public class consulta_colaborador extends JFrame {
	...
	public consulta_colaborador() {
		...
		JLabel lblNewLabel = new JLabel("Sistema de Consulta de Colaboradores");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel.setBounds(262, 4, 330, 19);
		...
		final DefaultTableModel modelo = new DefaultTableModel();
		        ...
		        try{
		            ...
		            while(rs.next()){
		             ...
		             modelo.addRow(new Object[] {cpf, rg, nome, data, sexo, endereco, escolaridade, cargo, telefone, email});
		            }
		        ...
		        scrollPane.setBounds(10, 34, 762, 342);
		        c.add(scrollPane);
